...
Plans:
- [ ] 01-01-PLAN.md -- Foundation: VaultClient Protocol, CLI client, parsers, exceptions, test infrastructure
- [ ] 01-02-PLAN.md -- Server + Core Tools: FastMCP server rewrite, migrate vault/links/tags/search/daily tools
...
|-------|----------------|--------|-----------|
| 1. CLI Migration | 1/5 | In Progress|  |
